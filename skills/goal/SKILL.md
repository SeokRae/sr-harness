---
name: goal
description: "plan/worktree 없이 자율 실행. /goal \"목표\" → Stop hook 기반으로 목표 달성까지 반복. pause/resume/clear/status 지원. Stop hook 기반 자율 반복이라 모델 자동 호출을 막았다. /goal 로만 진입한다. Keywords: goal, 목표, 자율 실행, 자동 반복, ralph 대안"
