---
name: pause
description: 세션 중단 및 다음 세션 인계 스킬. "세션 마무리해줘", "여기까지만", "다음 세션에서 이어서", "오늘은 여기까지", "잠깐 끊을게" 시 사용. session-plan.md를 최신화하여 start가 다음 세션에서 자동으로 이어받을 수 있게 한다.
---
...
session-plan.md 저장됨 → 다음 세션에서 start가 자동으로 이어받습니다.
```
